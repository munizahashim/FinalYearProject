...
X = dataset.drop('micro_district', axis=1).values  # Drop the 'condition' column to get the features
y = dataset['micro_district'].values               # Set the 'condition' column as the target
